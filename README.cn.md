...
合计: **133,055** 行代码（覆盖前 5 种语言、共 **441** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Python | 89,749 | 7,687 | 17,943 | 339 |
...
- **发布数**: 146 · **已合并 PR**: 3060 · **开放 PR**: 10 · **已关闭 issue**: 2785 · **开放 issue**: 67 · **提交数**: 11965
...
在 [repology.org](https://repology.org/project/xonsh) 上共有 **77** 个发行版报告此项目。**12** 个 ✅ 已是最新上游版本，**59** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260910.yml` · 2026-09-10T21:38:56Z._
